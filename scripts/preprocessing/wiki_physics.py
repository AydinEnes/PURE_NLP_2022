...
full_path = os.path.join(base_path.PROJECT_PATH, "files", "model_input_texts", "physics_texts", "wiki_physics_texts.txt")
full_path_titles = os.path.join(base_path.PROJECT_PATH, "files", "model_input_texts", "physics_texts","wiki_physics_texts_titles.txt")
