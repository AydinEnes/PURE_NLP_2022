...
full_path = os.path.join(base_path.PROJECT_PATH, "files", "model_input_texts", "chem_texts", "wiki_chem_texts.txt")
full_path_titles = os.path.join(base_path.PROJECT_PATH, "files", "model_input_texts", "chem_texts", "wiki_chem_titles.txt")
...
cats = "Kimya Taslakları,Kimyagerler,Atmosfer kimyası,Kimyasal bağlar,Kimyanın dalları,Kimya endüstrisi,Kimyasal formüller,Kimya güvenliği,Kimya yasaları,Kimya teorileri,Metalurji,Kimya mühendisliği,Kimyasal özellikler,Kimyasal savaş,Kimya tarihi,Kimyasal maddeler"
